...
Vagrant.configure(2) do |config|
  ...
  # The url where the box can be downloaded from 
...
## Machine specific stuff
  config.vm.define "pipe" do |pipe|
	...
	pipe.vm.synced_folder "server_www", "/var/www/html/"
  ...
  #  sudo apt-get install -y php5 libapache-mod-php5 php5-mcrypt php5-curl php5-mysql
  #SHELL
end
